      ...
      <div className="fields">
        <Field ordinal="A" label="Audio inputs" help="Mix any combination.">
          <div className="row-inline">
            <Pill
              active={runtime.mic}
              onClick={() => patch({ mic: !runtime.mic })}
            >
              Microphone
            </Pill>
            <Pill
              active={runtime.system}
              onClick={() => patch({ system: !runtime.system })}
            >
              System audio
            </Pill>
          </div>
        ...
        <Field
          ordinal="B"
          label="Encode"
          help="Codec inside a .webm container."
        >
          <Segment<CodecId>
            value={runtime.codec}
            options={CODECS}
        ...
        <Field
          ordinal="E"
          label="Countdown"
          help="Buffer before recording starts."
        >
          <Segment<string>
        ...
        <Field
          ordinal="F"
          label="Overlays"
          help="Compose extras directly into the recording (uses canvas - costs some CPU)."
        >
          <div className="row-inline">
            <Pill
              active={runtime.cursorHighlight}
              onClick={() =>
                patch({ cursorHighlight: !runtime.cursorHighlight })
              }
            >
              Cursor highlight
            </Pill>
            <Pill
              ...
              onClick={() =>
                patch({ keystrokeOverlay: !runtime.keystrokeOverlay })
              }
            >
              Keystrokes
            </Pill>
