...
const ROWS: PermRow[] = [
  {
    ...
    hint: "Required. Grant in System Settings.",
  },
  {
    kind: "microphone",
    label: "Microphone",
    hint: "Optional. Only needed for mic audio.",
  },
  {
    kind: "camera",
    label: "Camera",
    hint: "Optional. Only needed for webcam PiP.",
  },
];
        ...
        <div className="onb-hero">
          ...
          <div>
            ...
            <p className="onb-tagline">
              A distinctive screen recorder - three steps to your first take.
            </p>
          </div>
        </div>
          ...
          <div className={"onb-step" + (step >= 0 ? " onb-step--on" : "")}>
            ...
            <div className="onb-step__body">
              ...
              {isMac ? (
                <>
                  <p>
                    macOS requires you to enable each permission from System
                    Settings.
                  </p>
                ...
                <p>
                  On Windows and Linux, permissions are prompted the first time
                  you try to capture. You can skip this step.
                </p>
              )}
          ...
          {step >= 1 ? (
            <div className="onb-step onb-step--on">
              ...
              <div className="onb-step__body">
                <h3>Pick a source</h3>
                <p>
                  Every recording starts by selecting a screen or a specific
                  window. Thumbnails and search included.
                </p>
                <div className="onb-step__actions">
                  <Button
                    variant="ghost"
          ...
          {step >= 2 ? (
            <div className="onb-step onb-step--on">
              ...
              <div className="onb-step__body">
                ...
                <p>
                  Press <Kbd>R</Kbd> on the Ready screen or use the record
                  button. Stop with <Kbd>S</Kbd>, pause with <Kbd>P</Kbd>.
                  Global hotkeys work anywhere on your system.
                </p>
                <div className="onb-step__actions">
                  <Button
                    variant="ghost"
