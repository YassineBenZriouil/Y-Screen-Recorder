...
export function ReviewScreen({ onSave, onDiscard, onAgain, onCopyBlob, saving, autoSave }: Props) {
    ...
    if (!take) {
        return <section className="screen"><div className="empty">Nothing to review.</div></section>;
    }
    ...
    return (
        <section className="screen screen--review">
            ...
            <div className="review-grid">
                <div>
                    <Preview src={take.url} controls muted={false} autoPlay={false} corners="play" />
                </div>
            ...
            <footer className="screen__foot">
                <Button variant="danger-ghost" onClick={onDiscard} iconLeft={<Glyph name="trash" />}>
                    Throw away
                </Button>
                <Button variant="ghost" onClick={onAgain} iconLeft={<Glyph name="reload" />}>
                    Record another
                </Button>
                <Button
                    variant="primary"
